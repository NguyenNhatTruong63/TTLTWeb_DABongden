    ...
    <div class="container">
        <div class="detail_product">
            <div class="product_alpha">
                <a><img class="alpha_img" src="<%=product.getImg()%>" alt="">
            ...
            <div class="product_omega">
                ...
                <div class="product_content">
                    <div class="product_content1">
                        <p class="wattage">Công Suất: <%=productDetail.getWattage()%>
                        </p>
                        <p class="wattage_W"> Điện áp: <%=productDetail.getVoltage()%>
                        </p>
                        <p class="voltage0">Màu ánh sáng: <%=productDetail.getLight_color()%>
                        </p><br>
                        <p class="voltage0" style="margin-top: -20px">Mức tiêu thụ điện
                            năng: <%=productDetail.getConsumption()%>
                        </p>
                    </div>
                    <div class="product_content2">
                        <p class="luminous_flux">Quang Thông: <span
                                class="luminous_flux"><%=productDetail.getLuminousFlux()%>lm; CRI: <%=productDetail.getCri()%></span>
                        </p>
                        <p class="longevity0">Tuổi Thọ: <%=productDetail.getLongevity()%> Giờ</p>
                        <p class="age"> Ánh Sáng: <%=productDetail.getColorCover()%>
                        </p>
                        <p class="longevity0">Vật liệu: <%=productDetail.getMaterial()%>| <span
                                class="age"> Kích thước: <%=productDetail.getSize()%></span></p>
                    </div>
                </div>
                    ...
                    <div id="section_detail" class="">
                        <div class="container">
                            <div class="detail_infor1">
                                <div class="hv" style="border-top: solid 1px black; margin-top: 70px"></div>
                                <h1 style="text-align: center; font-size: 16px">Sản phẩm đèn led <%=product.getName()%>
                                </h1>
                                ...
                                <div class="detail_icon2">
                                    ...
                                    <div class="img">
                                        <img class="icon_detail2"
                                             src="https://rangdong.com.vn/uploads/images/Icon/icon_dientutruong.png">
                                    </div>
                                </div>
                                ...
                                <div class="detail_icon4">
                                    ...
                                    <img class="icon_detail4"
                                         src="https://rangdong.com.vn/uploads/images/Icon/icon_thanthienmoitruong.png">
                                </div>
