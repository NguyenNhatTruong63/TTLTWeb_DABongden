...
<%@ page import="org.example.ttltweb_bd.db.JDBIConnector" %>
<%@ page import="org.example.ttltweb_bd.beans.Product" %>
<%@ page import="jakarta.validation.constraints.Max" %>
<%--<%@ page import="org.example.ttltweb.services.Dao" %>--%>
